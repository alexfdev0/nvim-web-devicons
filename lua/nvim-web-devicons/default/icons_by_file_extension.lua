return {
  ...
  ["c"]              = { icon = "", color = "#F34B7D", cterm_color = "111", name = "C"                          },
  ...
  ["cp"]             = { icon = "", color = "#F34B7D", cterm_color = "74",  name = "Cp"                         },
  ["cpp"]            = { icon = "", color = "#F34B7D", cterm_color = "74",  name = "Cpp"                        },
  ["cppm"]           = { icon = "", color = "#F34B7D", cterm_color = "74",  name = "Cppm"                       },
  ...
  ["cxx"]            = { icon = "", color = "#F34B7D", cterm_color = "74",  name = "Cxx"                        },
  ["cxxm"]           = { icon = "", color = "#F34B7D", cterm_color = "74",  name = "Cxxm"                       },
  ...
  ["h"]              = { icon = "", color = "#F34B7D", cterm_color = "140", name = "H"                          },
  ...
  ["hh"]             = { icon = "", color = "#F34B7D", cterm_color = "140", name = "Hh"                         },
  ["hpp"]            = { icon = "", color = "#F34B7D", cterm_color = "140", name = "Hpp"                        },
  ...
  ["hxx"]            = { icon = "", color = "#F34B7D", cterm_color = "140", name = "Hxx"                        },
